...
The situation with the JavaScript ecosystem in TON is the opposite. The long-standing libraries like [`@ton/core`](https://github.com/ton-org/ton) and [`tonweb`](https://github.com/toncenter/tonweb) are,
